...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 610.0, 590.0, 85.0, 60.0 ],
					"text" : "run metro to see the latest value in dict.view"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1128.75, 3.718538565629217, 384.0, 22.0 ],
					"text" : "url localhost:3000"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 647.0, 508.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 647.0, 542.0, 56.0, 22.0 ],
					"text" : "metro 30"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 716.0, 508.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 715.75, 590.0, 297.0, 222.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 935.5, 352.0, 297.0, 222.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 716.0, 545.0, 57.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 715.75, 3.718538565629217, 384.0, 22.0 ],
					"text" : "reload"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 715.75, 39.718538565629217, 779.0, 425.562922868741566 ],
					"presentation" : 1,
					"presentation_rect" : [ 39.75, 9.718538565629217, 799.0, 869.56292286874168 ],
					"rendermode" : 0,
					"url" : "localhost:3000"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1056.5, 804.0, 387.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 935.5, 588.0, 387.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1056.5, 502.0, 288.0, 288.0 ],
					"pic" : "/Users/nickhwang/Downloads/pose_classification_pairwise_distances.png",
					"presentation" : 1,
					"presentation_rect" : [ 935.5, 38.718538565629217, 288.0, 288.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 20.0, 590.0, 400.0, 220.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 20.0, 423.0, 181.0, 22.0 ],
					"saved_object_attributes" : 					{
						"autostart" : 0,
						"defer" : 0,
						"watch" : 0
...
,
					"text" : "node.script main.js @autostart 0"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 0 ],
					"midpoints" : [ 319.5, 557.5, 29.5, 557.5 ],
					"source" : [ "obj-1", 1 ]
				}
...
, 			{
				"name" : "main.js",
				"bootpath" : "~/GitHub/MediaPipePoseMax",
				"patcherrelativepath" : ".",
				"type" : "TEXT",
				"implicit" : 1
			}
...
, 			{
				"name" : "pose_classification_pairwise_distances.png",
				"bootpath" : "~/Downloads",
